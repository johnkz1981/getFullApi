...
Class kod_emex extends CModule{
	var	$MODULE_ID = 'kod.emex';
	var $MODULE_VERSION;
	...
	function __construct(){
		...
		$this->MODULE_NAME = Loc::getMessage("KOD_EMEX_MODULE_NAME");
		$this->MODULE_DESCRIPTION = Loc::getMessage("KOD_EMEX_MODULE_DESC");

		$this->PARTNER_NAME = getMessage("KOD_EMEX_PARTNER_NAME");
		$this->PARTNER_URI = getMessage("KOD_EMEX_PARTNER_URI");
	...
	function DoInstall(){
		...
		if ($this->isVersionD7()){
			...
			$APPLICATION->ThrowException(Loc::getMessage("KOD_EMEX_INSTALL_ERROR_VERSION"));
		}

		$APPLICATION->IncludeAdminFile(Loc::getMessage("KOD_EMEX_INSTALL"), $this->GetPath()."/install/step.php");
	}
	...
	function DoUninstall(){
		...
		$APPLICATION->IncludeAdminFile(Loc::getMessage("KOD_EMEX_UNINSTALL"), $this->GetPath()."/install/unstep.php");
	}
}
?>